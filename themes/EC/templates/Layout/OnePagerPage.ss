    ...
    <section>
        <div class="row super-row">
            <ul class="like-blocks">
                ...
                <li><a href="http://entrepreneur-club.org/blog" target="_blank"><span class="mr10 entypo-newspaper"> <span class="hide-for-small-span">Read our </span>Blog</a></li>
            </ul>
        </div>
    </section>
    <section id="about-us">
    ...
    <footer>
        <div class="row">
            ...
            <div class="large-4 columns right" style="margin-top:30px;margin-left:-40px;font-size:1.25em; text-align:right;">
                ...
                <a href="http://entrepreneur-club.org/blog" target="_blank">Blog</a>
            </div>
        </div>
    </footer>
</body>